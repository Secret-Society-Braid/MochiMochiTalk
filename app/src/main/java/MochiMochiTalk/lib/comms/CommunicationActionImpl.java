...
public class CommunicationActionImpl implements CommunicationAction {
    ...
    private static final ExecutorService DEFAULT_EXECUTOR = Executors.newFixedThreadPool(DEFAULT_CONCURRENCY, new CountingThreadFactory(() -> "MochiMochiTalk", "InterClassCommunication Thread", false));

    private static final ExecutorService DEFAULT_INTERNAL_EXECUTOR = Executors.newCachedThreadPool(new CountingThreadFactory(() -> "MochiMochiTalk", "CommunicationAction Internal Process Thread"));
