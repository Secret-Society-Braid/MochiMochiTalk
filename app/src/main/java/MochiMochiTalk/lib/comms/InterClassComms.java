...
public class InterClassComms implements IClassComms {
    ...
    @Nonnull
    @Override
    public synchronized Class<?> getSendTo() throws IllegalStateException, UnsupportedOperationException {
        if(closed)
    ...
    @Override
    public synchronized void setRecipients(Collection<Class<?>> recipients) throws IllegalStateException {
        if(closed)
            throw new IllegalStateException("cannot invoke this method after sending");
        else
    ...
    @Nonnull
    @Override
    public synchronized Collection<Class<?>> getRecipients() throws IllegalStateException, UnsupportedOperationException {
        if(closed)
    ...
    @Nonnull
    @Override
    public synchronized String getMessage() throws IllegalStateException, UnsupportedOperationException {
        if(closed)
            return this.message;
